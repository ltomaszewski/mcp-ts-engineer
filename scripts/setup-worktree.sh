...
# Determine worktree root. This script lives at MONOREPO_ROOT/scripts/setup-worktree.sh,
# so go up one level from the script's directory.
...
# Step 1: Initialize git submodules (worktrees don't auto-init submodules)
...
# Step 3: Build all workspace packages via turbo
echo "Step 3/4: Building workspace packages..."
npx turbo run build

# Step 4: Auto-detect and build non-turbo packages
echo "Step 4/4: Additional builds..."
