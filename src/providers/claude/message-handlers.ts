...
): { blocks: AIContentBlock[]; textChunks: string[] } {
...
export function processUserMessage(
  ...
  acc.currentTurn.toolResults.push({
    ...
    content: typeof msg.tool_use_result === "string"
      ? msg.tool_use_result
...
export function processResultMessage(
  ...
  if (msg.usage) {
    ...
    acc.usage = {
      ...
      totalTokens: acc.usage.inputTokens + newInputTokens + acc.usage.outputTokens + newOutputTokens,
      promptCacheWrite:
