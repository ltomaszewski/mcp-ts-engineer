...
import type { AIQueryResult, AIProvider } from "../../ai-provider/ai-provider.types.js";
import {
  ValidationError,
  AIProviderError,
  TimeoutError,
  ...
  describe("Helper Functions", () => {
    ...
    describe("extractModelFromCostSummary", () => {
      it("returns first model from byModel with single model", () => {
        const costSummary = {
          byModel: {
            "claude-3-5-sonnet-20241022": { inputTokens: 100, outputTokens: 50, costUsd: 0.01, count: 1 },
          },
      ...
      it("returns first model from byModel with multiple models", () => {
        const costSummary = {
          byModel: {
            "claude-3-5-sonnet-20241022": { inputTokens: 100, outputTokens: 50, costUsd: 0.01, count: 1 },
            "claude-3-5-haiku-20241022": { inputTokens: 50, outputTokens: 25, costUsd: 0.005, count: 1 },
          },
