...
describe('CostTracker', () => {
  ...
  describe('recordCost', () => {
    it('records cost entry for session', () => {
      ...
      tracker.recordCost(
        'abc1230000000000000000000000000000',
        'invabcd000000000000000000000000000',
        'tool-a',
        entry,
      )
    ...
    it('records multiple cost entries for same session', () => {
      ...
      tracker.recordCost(
        'abc1230000000000000000000000000000',
        'invaaa100000000000000000000000000',
        'tool-a',
        entry1,
      )
      tracker.recordCost(
        'abc1230000000000000000000000000000',
        'invaaa200000000000000000000000000',
        'tool-b',
        entry2,
      )
    ...
    it('handles zero-cost entries (cached responses)', () => {
      ...
      tracker.recordCost(
        'abc1230000000000000000000000000000',
        'invcached00000000000000000000000',
        'tool-cached',
        entry,
      )
  ...
  describe('getSessionSummary', () => {
    ...
    it('returns summary with by_capability breakdown', () => {
      ...
      tracker.recordCost(
        'abc1230000000000000000000000000000',
        'invaaa300000000000000000000000000',
        'tool-b',
        entry1,
      )
  ...
  describe('getAllSessionSummaries', () => {
    it('returns summaries for all tracked sessions', () => {
      ...
      tracker.recordCost(
        'def4560000000000000000000000000000',
        'invaaa200000000000000000000000000',
        'tool-b',
        entry2,
      )
      ...
      expect(summaries.get('def4560000000000000000000000000000')?.totalCostUsd).toBeCloseTo(
        0.005,
        5,
      )
    })
  ...
  describe('floating-point accumulation', () => {
    it('handles floating-point arithmetic correctly', () => {
      ...
      for (const entry of entries) {
        tracker.recordCost(
          'aaa1110000000000000000000000000000',
          `inv${entry.id}00000000000000000000`,
          'tool',
          entry,
        )
      }
  ...
  describe('getChildCostEntries', () => {
    ...
    it('returns empty array when no child entries exist', () => {
      ...
      tracker.recordCost(
        'session000000000000000000000000000',
        'inv-regular',
        'cap-regular',
        regularEntry,
      )
