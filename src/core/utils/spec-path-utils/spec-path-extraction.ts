...
export function extractFilePaths(content: string): string[] {
  ...
  const contentWithoutCodeBlocks = content.replace(PATH_PATTERNS.FENCED_CODE_BLOCK, '')
  const inlineMatches = contentWithoutCodeBlocks.matchAll(PATH_PATTERNS.INLINE_CODE)
