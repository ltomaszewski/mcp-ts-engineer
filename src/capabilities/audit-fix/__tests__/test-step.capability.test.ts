...
describe("auditFixTestStepCapability", () => {
  describe("definition metadata", () => {
    ...
    it("defaults to sonnet model", () => {
      expect(auditFixTestStepCapability.defaultRequestOptions?.model).toBe("sonnet");
    });
    ...
    it("has bypassPermissions enabled", () => {
      expect(auditFixTestStepCapability.defaultRequestOptions?.permissionMode).toBe("bypassPermissions");
    });

    it("has allowDangerouslySkipPermissions enabled", () => {
      expect(auditFixTestStepCapability.defaultRequestOptions?.allowDangerouslySkipPermissions).toBe(true);
    });
