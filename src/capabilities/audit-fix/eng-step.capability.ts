...
const engStepPromptV1: PromptVersion = {
  ...
  description:
    "Eng fix step: applies audit fixes using shared eng prompt in fix mode",
  deprecated: false,
 ...
 */
export const auditFixEngStepCapability: CapabilityDefinition<
  EngStepInput,
  EngFixResult
> = {
  ...
  defaultRequestOptions: {
    ...
    get appendSystemPrompt() { return buildDevContext(); },
  },
