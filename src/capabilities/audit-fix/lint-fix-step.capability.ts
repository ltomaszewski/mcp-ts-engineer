...
import {
  parseXmlBlock,
  parseJsonSafe,
  LINT_FIX_RESULT_FALLBACK,
} from "./audit-fix.helpers.js";
import type { LintFixInput, LintFixResult } from "./audit-fix.schema.js";
import { lintFixPrompts, LINT_FIX_CURRENT_VERSION } from "./prompts/index.js";
 ...
 */
export const auditFixLintFixStepCapability: CapabilityDefinition<
  LintFixInput,
  LintFixResult
> = {
