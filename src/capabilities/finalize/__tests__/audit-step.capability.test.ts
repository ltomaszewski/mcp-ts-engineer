...
describe("finalizeAuditStepCapability", () => {
  describe("definition metadata", () => {
    ...
    it("defaults to sonnet model", () => {
      expect(finalizeAuditStepCapability.defaultRequestOptions?.model).toBe("sonnet");
    });
    ...
    it("has bypassPermissions enabled", () => {
      expect(finalizeAuditStepCapability.defaultRequestOptions?.permissionMode).toBe("bypassPermissions");
    });

    it("has allowDangerouslySkipPermissions enabled", () => {
      expect(finalizeAuditStepCapability.defaultRequestOptions?.allowDangerouslySkipPermissions).toBe(true);
    });
