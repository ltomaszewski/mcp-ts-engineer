...
describe("finalizeTestStepCapability", () => {
  describe("definition metadata", () => {
    ...
    it("has bypassPermissions enabled", () => {
      expect(finalizeTestStepCapability.defaultRequestOptions?.permissionMode).toBe("bypassPermissions");
    });

    it("has allowDangerouslySkipPermissions enabled", () => {
      expect(finalizeTestStepCapability.defaultRequestOptions?.allowDangerouslySkipPermissions).toBe(true);
    });
