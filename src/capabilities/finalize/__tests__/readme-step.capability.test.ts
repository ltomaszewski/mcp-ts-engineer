...
describe("finalizeReadmeStepCapability", () => {
  ...
  describe("default options", () => {
    ...
    it("has bypassPermissions enabled", () => {
      expect(finalizeReadmeStepCapability.defaultRequestOptions?.permissionMode).toBe("bypassPermissions");
      expect(finalizeReadmeStepCapability.defaultRequestOptions?.allowDangerouslySkipPermissions).toBe(true);
    });
  });
