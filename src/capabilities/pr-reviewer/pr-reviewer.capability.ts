...
import {
  PR_REVIEWER_PROMPT_VERSIONS,
  PR_REVIEWER_CURRENT_VERSION,
 ...
 */
export const prReviewerCapability: CapabilityDefinition<
  PrReviewerInput,
  PrReviewerOutput
> = {
  id: "pr_reviewer",
  ...
  description:
    ...
    "Supports review-only and review-fix modes with budget controls. " +
