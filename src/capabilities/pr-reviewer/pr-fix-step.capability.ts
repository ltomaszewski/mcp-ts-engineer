...
const FIX_PROMPT_V1: PromptVersion = {
  ...
  build: (input: unknown) => {
    ...
    // Build project patterns section if available
    const projectPatternsSection = data.project_context
      ? `## Project Patterns
...
export const prFixStepCapability: CapabilityDefinition<FixStepInput, FixStepOutput> = {
  id: 'pr_fix_step',
  type: 'tool',
  visibility: 'internal',
  name: 'PR Fix Step',
