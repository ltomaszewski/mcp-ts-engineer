...
export const prValidateStepCapability: CapabilityDefinition<ValidateStepInput, ValidateStepOutput> =
  {
    id: 'pr_validate_step',
    type: 'tool',
    visibility: 'internal',
    ...
    processResult: (
      ...
      if (xmlContent)
        return parseJsonSafe(xmlContent, ValidateStepOutputSchema, passThroughFallback())
